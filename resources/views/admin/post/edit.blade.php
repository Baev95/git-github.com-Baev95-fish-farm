...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit news: {{ $post['title'] }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
                        ...
                        <form action="{{ route('post.update', $post['id']) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $post['title_en'] }}" name="title_en"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $post['title_ge'] }}" name="title_ge"
                                        class="form-control" id="exampleInputEmail1"
                                        placeholder="Enter the name of the news" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Edit text in English (The editor of filling out the article for the English
                                        version of
                                        the news.)</label>
                                    <textarea name="text_en" class="editor">{{ $post['text_en'] }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Edit text in Georgian (editor filling out an article for the Georgian version of
                                        the
                                        news.)</label>
                                    <textarea name="text_ge" class="editor">{{ $post['text_ge'] }}</textarea>
                                </div>
