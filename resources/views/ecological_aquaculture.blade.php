        ...
        <section class="bread">
            <div class="container bread__wrapper">
                ...
                <div class="bread__block">
                    <h1 class="bread__h1">@lang('public.ecological_aquaculture')</h1>
                </div>
        ...
        <section class="news m60">
            <div class="container news__wrapper">
                <div class="news__block">
                    <p>
                        @lang('news.ecological_aquaculture.introduction')
                    </p>
                    <ol>
                        <li>@lang('news.ecological_aquaculture.conservation_natural_resources')</li>
                        <li>@lang('news.ecological_aquaculture.preservation_biodiversity')</li>
                        <li>@lang('news.ecological_aquaculture.enhanced_water_quality')</li>
                        <li>@lang('news.ecological_aquaculture.carbon_footprint_reduction')</li>
                        <li>@lang('news.ecological_aquaculture.social_economic_benefits')</li>
                        <li>@lang('news.ecological_aquaculture.reduced_pressure_wild_wish_stocks')</li>
                    </ol>
                    <div>
                        <p>
                            @lang('news.ecological_aquaculture.conclusion')
                        </p>
                    </div>
